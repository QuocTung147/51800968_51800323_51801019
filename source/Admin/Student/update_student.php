...
<body>
<form action="updateprofilestudentbyAdmin.php" method="POST" enctype="multipart/form-data">
    <div class="container">
        <div class="row profile">
            ...
            <div class="col-md-9">
                <div class="profile-content">
                    ...
                    <div class="form-group col-md-9">
                    <button type="submit" class="btn btn-info" name="updateProfileid" value="<?= $user['ID']?>">Update</button>
                    </div>
                </div>
            </div>
        </div>
