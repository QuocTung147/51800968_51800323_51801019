...
<body>
    <div class="container">
        ...
        $start_from = ($page-1)*$record_per_page;
            ...
            $conn=getDB();            
            $sql = "SELECT * FROM khoungdung WHERE Type = 'tienganh' AND TrangThai = 1 ORDER BY Luottai Desc LIMIT $start_from, $record_per_page";
                ...
                <div>
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center" id='pag-container'>
                            <?php
                                $page_query = "SELECT * FROM khoungdung WHERE Type = 'tienganh' AND TrangThai = 1";
                            ...
                            <li class='page-item pagination-li mr-2'><a class='page-link'
                                    href='index.php?page=trochoi&&page_no=<?=$i?>'><?=$i?></a></li>
                            <?php
                                        }
                                    ?>
                        </ul>
