    ...
    <div class="container">
        <div class="row">
         ...
         $start_from = ($page-1)*$record_per_page;
            ...
            $conn=getDB();            
            $sql = "SELECT * FROM khoungdung WHERE GiaTien = 0 AND TrangThai = 1 ORDER BY Luottai Desc LIMIT $start_from, $record_per_page ";
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center" id='pag-container'>
                            ...
                            <li class='page-item pagination-li mr-2'><a class='page-link'
                                    href='index.php?page=most_free_app&&page_no=<?=$i?>'><?=$i?></a></li>
                            <?php
                                        }
                                    ?>
                        </ul>
